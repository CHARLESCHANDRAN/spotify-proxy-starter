...
app.get("/api/spotify/recommendations", async (req, res) => {
	try {
		...
		if (req.query.seed_artists)
			params.append("seed_artists", req.query.seed_artists);
		if (req.query.seed_tracks)
			params.append("seed_tracks", req.query.seed_tracks);
		if (req.query.seed_genres)
			params.append("seed_genres", req.query.seed_genres);

		// If no seeds provided, use default popular genres
		if (
			!params.has("seed_artists") &&
			!params.has("seed_tracks") &&
			!params.has("seed_genres")
		) {
		...
		// Market
		if (req.query.market) params.append("market", req.query.market);
